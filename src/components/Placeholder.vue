...
const toneClasses = computed(() => {
  if (props.tone === 'burgundy') {
    return 'text-white/85 bg-[linear-gradient(135deg,#a32525,#771b1c)] before:ph-stripes-light'
  }
  if (props.tone === 'green') {
    return 'text-white/90 bg-[linear-gradient(135deg,#a5cc52,#80a13a)] before:ph-stripes-green'
  }
  return 'text-ink-3 bg-bg-soft-2 before:ph-stripes'
})
