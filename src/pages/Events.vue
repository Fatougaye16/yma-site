...
const upcoming = [
  { day:'24', mo:'May', y:'2026', title:'Greater Banjul Regional Math Round', loc:'GTTI Hall, Kanifing', time:'9:00 AM – 2:00 PM', tag:'Olympiad', desc:'Regional qualifier for the Gambia Math Olympiad. Open to grades 7–12.' },
  { day:'07', mo:'Jun', y:'2026', title:'Geometry Without Coordinates', loc:'YMA Center, Pipeline', time:'10:00 AM – 12:30 PM', tag:'Workshop', desc:'Intuitive synthetic geometry: angles, circles, and elegant proofs.' },
  { day:'15', mo:'Jun', y:'2026', title:'Central River Regional Round', loc:'Janjanbureh Senior Secondary', time:'9:00 AM – 2:00 PM', tag:'Olympiad', desc:'CRR qualifier. Travel & lunch provided for participating schools.' },
  { day:'22', mo:'Jun', y:'2026', title:'Parents & Mentors Open Day', loc:'British Council, Bertil Harding', time:'3:00 PM – 5:00 PM', tag:'Community', desc:'Meet our mentors, see student work, ask anything.' },
  { day:'05', mo:'Jul', y:'2026', title:'GMO National Finals', loc:'University of The Gambia, Faraba', time:'All day', tag:'Olympiad', desc:'The national final. Top 12 students join the GMO Team.' },
  { day:'18', mo:'Jul', y:'2026', title:'Mentor Onboarding (Cohort 14)', loc:'YMA Center, Pipeline', time:'10:00 AM – 4:00 PM', tag:'Mentorship', desc:'Training day for new mentors joining the autumn cohort.' },
]

const past = [
  { day:'12', mo:'Apr', y:'2026', title:'Easter Bootcamp · Number Theory', img:'bootcamp-apr.jpg', tag:'Bootcamp', tone:'soft', recap:'40 students, 5 days, one beautiful problem each morning.' },
  { day:'27', mo:'Mar', y:'2026', title:'Girls in Math Day', img:'girls-math.jpg', tag:'Community', tone:'burgundy', recap:'130 girls from 22 schools, panel with 3 women in STEM.' },
  { day:'15', mo:'Mar', y:'2026', title:'Lower River Regional Round', img:'lrr-round.jpg', tag:'Olympiad', tone:'green', recap:'First time we hosted in Mansa Konko. 64 participants.' },
  { day:'09', mo:'Feb', y:'2026', title:'Teacher Clinic Vol. 12', img:'teacher-clinic.jpg', tag:'Teacher', tone:'soft', recap:'A lesson on Pythagoras without rote — 18 teachers attended.' },
  { day:'21', mo:'Jan', y:'2026', title:'New Year Problem Set Launch', img:'problem-set.jpg', tag:'Workshop', tone:'burgundy', recap:'52-problem set released free for all secondary schools.' },
  { day:'14', mo:'Dec', y:'2025', title:'December Bootcamp · Combinatorics', img:'dec-bootcamp.jpg', tag:'Bootcamp', tone:'green', recap:'Closing showcase: students built their own problem sets.' },
]
  ...
  <section class="section-y">
    <div class="container-yma">
      <div class="flex gap-1.5 border-b border-line overflow-x-auto mb-10">
        <span
          v-for="(t, idx) in [{k:'upcoming',l:'Upcoming',c:upcoming.length},{k:'past',l:'Past events',c:past.length},{k:'flyer',l:'Event detail'}]" :key="idx"
          :class="[
        ...
        >
          {{ t.l }}
          <span v-if="t.c !== undefined"
                :class="['ml-1.5 px-2 py-0.5 rounded-full text-[11px] font-bold',
                         tab === t.k ? 'bg-burgundy-soft text-burgundy' : 'bg-bg-soft-2 text-ink-3']">{{ t.c }}</span>
        </span>
      </div>

      <template v-if="tab === 'upcoming'">
        <div class="flex gap-2 flex-wrap mb-8">
          <button class="px-3.5 py-2 rounded-full text-[13px] font-semibold bg-burgundy text-white cursor-pointer">All</button>
          <button v-for="f in ['Olympiad','Workshop','Community','Mentorship']" :key="f"
        ...
        <div>
          ...
          >
            <div class="bg-burgundy text-white rounded-[10px] py-3.5 px-3 max-sm:py-2.5 max-sm:px-2 text-center font-display leading-none">
              <span class="block text-xs font-sans font-bold tracking-[0.14em] uppercase mb-1 opacity-90">{{ e.mo }}</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-12">
          <div>
            ...
            <div class="flex gap-6 flex-wrap text-sm text-ink-3 mb-8 pb-6 border-b border-line">
              <span class="inline-flex items-center gap-2"><Icon name="calendar" :size="14"/> Sat, 5 Jul 2026 · 9:00 AM – 4:00 PM</span>
              <span class="inline-flex items-center gap-2"><Icon name="pin" :size="14"/> University of The Gambia, Faraba Campus</span>
              <span class="inline-flex items-center gap-2"><Icon name="users" :size="14"/> 96 finalists, 6 regions</span>
            </div>
            <p class="text-[17px] leading-relaxed text-ink-2 mb-6">
              The national final of the Gambia Math Olympiad brings together 96 students from regional rounds for a single day of problem-solving, mentorship, and a closing ceremony. Top 12 finalists join the GMO Team and represent The Gambia at the Pan-African Mathematics Olympiad.
            </p>

            <h3 class="text-xl font-bold mb-6 mt-8">Schedule</h3>
            <div class="grid gap-2">
              <div
                v-for="(s, i) in schedule" :key="i"
            ...
            <div class="lg:sticky lg:top-25">
              <div class="bg-white rounded-xl overflow-hidden border border-line shadow-(--shadow-soft-md)">
                ...
                <div class="p-5 flex flex-col gap-2">
                  ...
                  <button class="btn btn-primary mt-4" @click="go('register')">Begin registration <Icon name="arrow"/></button>
              ...
              <div class="p-6 mt-6 bg-bg-soft rounded-xl">
                ...
                <div class="flex gap-2">
                  <button v-for="n in ['fb','tw','wa','mail']" :key="n"
