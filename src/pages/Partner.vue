    ...
    <form v-else class="grid gap-5" @submit.prevent="submit">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div class="flex flex-col gap-2">
          <label class="text-[13px] font-semibold text-ink">Organization name <span class="text-burgundy">*</span></label>
      ...
      <div class="flex flex-col gap-2">
        <label class="text-[13px] font-semibold text-ink">Partnership interest <span class="text-burgundy">*</span></label>
      ...
      <div class="flex flex-col gap-2">
        ...
        <textarea required placeholder="What would a great partnership look like for you? Budget, timing, audience…" class="field-input resize-y min-h-30"/>
      </div>
      <div class="flex flex-col gap-2">
      ...
      <button type="submit" class="btn btn-primary btn-lg justify-self-start">Send inquiry <Icon name="arrow"/></button>
    </form>
  </FormShell>
</template>
