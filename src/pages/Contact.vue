...
const faqs = [
  { q:'How does a student join YMA?', a:'Fill in the Join Us form (or your school can register a group). We will get in touch within a week, match you to a nearby Saturday club, and send a welcome pack.' },
  { q:'Is there a fee?', a:'No. All YMA programs are free for students. We are funded by partners and small grants. Donations from individuals are welcome but never required.' },
  { q:'How do I volunteer as a mentor?', a:'Submit the Volunteer form. We run mentor onboarding every other month — it is one day, plus a short background check. Mentors commit to roughly 4 hours per month.' },
  { q:'Can YMA come to my school?', a:'Yes. Use the Contact form, pick "Partnership" and tell us a bit about your school and timing. We try to visit every region twice a year.' },
  { q:'Do you support girls-only programs?', a:'Yes. We run a Girls in Math Day annually and several of our regional rounds are deliberately girls-first to lower the social cost of participating.' },
]
</script>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-10 lg:gap-16">
        ...
        <div>
          ...
          >
            ...
            <p class="m-0 text-ink-2">We will reply within two working days. In the meantime, you might enjoy our latest posts.</p>
          ...
          <form v-else class="grid gap-5" @submit.prevent="submit">
            ...
            <div class="flex flex-col gap-2">
              ...
              <textarea required placeholder="Tell us about you, your school, or what you'd like to ask…" class="field-input resize-y min-h-30"/>
            </div>
            <div class="flex flex-col gap-2">
              <label class="text-[13px] font-semibold text-ink">Attach a file (optional)</label>
              <div class="p-6 border-[1.5px] border-dashed border-line-2 rounded-[10px] text-center cursor-pointer text-ink-3 bg-bg-soft">
            ...
            <button type="submit" class="btn btn-primary btn-lg justify-self-start">Send message <Icon name="arrow"/></button>
          </form>
        </div>
        ...
        <div>
          ...
          <div class="grid gap-4">
            <div class="flex gap-4 p-5 rounded-xl bg-white border border-line items-center transition-all duration-180 cursor-pointer hover:border-burgundy hover:-translate-y-0.5">
              <div class="w-11 h-11 rounded-[10px] bg-burgundy-soft text-burgundy grid place-items-center shrink-0"><Icon name="mail"/></div>
              <div>
            ...
            <div class="flex gap-4 p-5 rounded-xl bg-white border border-line items-center transition-all duration-180 cursor-pointer hover:border-burgundy hover:-translate-y-0.5">
              <div class="w-11 h-11 rounded-[10px] bg-burgundy-soft text-burgundy grid place-items-center shrink-0"><Icon name="phone"/></div>
              <div>
            ...
            <div class="flex gap-4 p-5 rounded-xl bg-white border border-line items-center transition-all duration-180 cursor-pointer hover:border-burgundy hover:-translate-y-0.5">
              <div class="w-11 h-11 rounded-[10px] bg-green-soft text-green-dark grid place-items-center shrink-0"><Icon name="wa"/></div>
              <div>
          ...
          <div class="mt-6">
            <div class="aspect-4/3 rounded-xl overflow-hidden border border-line relative bg-bg-soft">
              <svg viewBox="0 0 400 300" class="w-full h-full">
                ...
                <path d="M 0 180 Q 100 160 200 175 T 400 170" stroke="#95ba45" stroke-width="2" fill="none" opacity="0.5"/>
                <path d="M 0 200 Q 120 220 240 200 T 400 195" stroke="#95ba45" stroke-width="14" fill="none" opacity="0.18"/>
                <text x="40" y="80" font-size="11" fill="#6b6562" font-family="ui-monospace, monospace">Kanifing</text>
                <text x="260" y="60" font-size="11" fill="#6b6562" font-family="ui-monospace, monospace">Serrekunda</text>
                <text x="100" y="240" font-size="11" fill="#6b6562" font-family="ui-monospace, monospace">Bertil Harding Hwy</text>
                <g transform="translate(180, 130)">
                  <circle r="14" fill="#8f2021" opacity="0.2"/>
                  <circle r="8" fill="#8f2021"/>
                  <path d="M 0 -2 L 0 8" stroke="#fff" stroke-width="2"/>
                  <text y="-22" text-anchor="middle" font-size="10" fill="#8f2021" font-weight="700" font-family="Manrope, sans-serif">YMA CENTER</text>
                </g>
              </svg>
            </div>
            <div class="mt-4 p-4 bg-white border border-line rounded-xl">
              ...
              <div class="mt-3 text-[13px] text-ink-2">
                <strong>Open:</strong> Mon–Fri, 10am–6pm · Sat, 9am–1pm
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="flex justify-between items-center gap-6 font-bold text-[17px] text-ink">
            ...
            <div
              :class="[
                ...
                openFaq === i
                  ? 'bg-burgundy text-white rotate-45'
                  : 'bg-bg-soft text-burgundy',
              ]"
            >
